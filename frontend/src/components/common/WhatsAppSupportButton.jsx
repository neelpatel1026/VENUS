...
const WhatsAppSupportButton = () => {
  ...
  useEffect(() => {
    ...
    // Show tooltip after a brief 1.5s delay (desktop only handles hover, let's toggle initially)
  ...
  return (
    <div 
      ...
      onMouseEnter={() => { if (window.innerWidth > 768) setShowTooltip(true); }}
    ...
    >
      ...
      <a
        href="https://wa.me/919999999999?text=Hi%20VENUS%20CARE%2C%20I%20need%20help%20with%20my%20order%20and%20skincare%20consultation."
        target="_blank"
        rel="noopener noreferrer"
        className="whatsapp-float-btn pulse-animate"
